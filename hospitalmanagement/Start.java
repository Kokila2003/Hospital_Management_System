...
public class Start extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        load.setPreferredSize(new java.awt.Dimension(146, 10));

        per.setFont(new java.awt.Font("Gabriola", 1, 40)); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\ELCOT\\Desktop\\java\\LOGO1.png")); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(per, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        Start st=new Start();
        st.setVisible(true);
        for(int i=st.load.getMaximum();i<=st.load.getMaximum();i+=5){
            st.load.setValue(i);
            st.load.setString(""+i+"");
            st.per.setText(Integer.toString(i)+"%");
            try{
                Thread.sleep(150);
            }catch(Exception e){
